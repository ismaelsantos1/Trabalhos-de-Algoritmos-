...
def accepted():
    messagebox.showinfo('Meu amor', 'Quer sair comigo?')
...
text_id = tk.Label(root, bg='#ffc8dd', text='Topa namorar comigo?', fg='#590d22', font=('Montserrat', 24, 'bold'))
text_id.pack()
...
button_2 = tk.Button(root, text='Sim', bg='#ffb3c1', relief=tk.RIDGE, bd=3, command=accepted, font=('Montserrat', 14, 'bold'))
button_2.pack()
